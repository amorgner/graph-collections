...
public class SortedTree implements NodeCollection//Iterable<Relationship>
{
	 ...
	 * the nodes.
	 * @param isUniqueIndex determines if every entry in the tree needs to
	 * have a unique comparator value
	 * @param treeName value set on both the TREE_ROOT and the KEY_VALUE
	 * relations.
	 */
